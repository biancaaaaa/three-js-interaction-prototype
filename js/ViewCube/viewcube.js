...
FOUR.Viewcube = (function () {
    ...
    Viewcube.prototype.setupGeometry = function () {
        ...
        var material1 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('/js/ViewCube/img/top.png'),
            opacity: 1.0,
            transparent: true
        });
        var material2 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('/js/ViewCube/img/front.png'),
            opacity: 1.0,
            transparent: true
        });
        var material3 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('/js/ViewCube/img/right.png'),
            opacity: 1.0,
            transparent: true
        });
        var material4 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('/js/ViewCube/img/back.png'),
            opacity: 1.0,
            transparent: true
        });
        var material5 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('/js/ViewCube/img/left.png'),
            opacity: 1.0,
            transparent: true
        });
        var material6 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('/js/ViewCube/img/bottom.png'),
            opacity: 1.0,
            transparent: true
        });
        var materials = [
        ...
        var labels = new THREE.Mesh(geometry, materials);
        labels.name = 'labels';
